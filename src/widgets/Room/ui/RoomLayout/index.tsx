...
export const RoomLayout: FC<RoomLayoutProps> = ({
  ...
  const [themeColors, setThemeColors] = useState({
    ...
    anchorFill: '#ffffff',
    anchorStroke: '#0a0a0a',
    selectionFill: 'rgba(0, 232, 198, 0.18)',
  });
  ...
  useLayoutEffect(() => {
    ...
    const primary = s.getPropertyValue('--primary').trim() || '#0a0a0a';
    const background = s.getPropertyValue('--background').trim() || '#fffef6';
    const selectionFill =
      s.getPropertyValue('--selection-box-fill').trim() || 'rgba(0, 232, 198, 0.18)';
    setThemeColors({
      selection: primary,
